...
The stochastic scheduling problem cannot be differentiated directly. SPTO+ derives a differentiable convex upper bound on the optimality gap from Lagrangian duality. The bound supplies the gradient, and the scheduling problem remains the source of the learning signal.
